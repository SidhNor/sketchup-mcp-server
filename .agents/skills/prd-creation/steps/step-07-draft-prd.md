...
Assemble the PRD into the required structure without leaking architecture or implementation detail into the product document.
...
1. Create the PRD using `templates/prd-template.md`.
2. Persist it as `specifications/prds/prd-<slug>.md`.
...
Proceed to Step 08 once the full PRD draft exists.
